...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="/pic/laporanhyarihatto"
                   class="{{ request()->is('pic/laporanhyarihatto*') ? 'active' : '' }}">
                    <i class="bi bi-journal-text"></i> <span>Laporan Hyari Hatto</span>
                </a>
            </li>
            
            <li>
                <a href="/pic/komitmenk3"
            ...
            <li>
                <a href="/pic/safetypatroltemuan"
                   class="{{ request()->is('pic/safetypatroltemuan*') ? 'active' : '' }}">
                    <i class="bi bi-shield-lock"></i> <span>Temuan Safety Patrol</span>
                </a>
            </li>

            <li>
                <a href="/pic/safetyridingtemuan"
                   class="{{ request()->is('pic/safetyridingtemuan*') ? 'active' : '' }}">
                    <i class="bi bi-bicycle"></i> <span>Temuan Safety Riding</span>
                </a>
            </li>
        </ul>
