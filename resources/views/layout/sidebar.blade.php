...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="menu">
            {{-- DASHBOARD --}}
            <li>
                <a href="/she/dashboard"
                   class="{{ request()->is('she/dashboard') ? 'active' : '' }}">
                    <i class="bi bi-speedometer2"></i> <span>Dashboard</span>
                </a>
            </li>

            {{-- HYARI HATTO (Menu Single) --}}
            <li>
                <a href="/she/hyari-hatto"
                   class="{{ request()->is('she/hyari-hatto*') ? 'active' : '' }}">
                    <i class="bi bi-journal-check"></i> <span>Hyari Hatto</span>
                </a>
            </li>
            ...
            <li>
                <a href="/she/insiden"
                   class="{{ request()->is('she/insiden*') ? 'active' : '' }}">
                    <i class="bi bi-x-octagon"></i> <span>Insiden</span>
                </a>
            </li>

            {{-- KOMITMEN K3 --}}
            <li>
                <a href="/she/komitmen-k3"
                   class="{{ request()->is('she/komitmen-k3*') ? 'active' : '' }}">
                    <i class="bi bi-file-earmark-check"></i> <span>Komitmen K3</span>
                </a>
            </li>

            {{-- SAFETY RIDING --}}
            <li>
                <a href="/she/safety-riding"
                   class="{{ request()->is('she/safety-riding*') ? 'active' : '' }}">
                    <i class="bi bi-bicycle"></i> <span>Safety Riding</span>
                </a>
            </li>
            
            {{-- SAFETY PATROL --}}
            <li>
                <a href="/she/safety-patrol"
                   class="{{ request()->is('she/safety-patrol*') ? 'active' : '' }}">
                    <i class="bi bi-shield-lock"></i> <span>Safety Patrol</span>
                </a>
            </li>
            
            {{-- GARIS PEMISAH (Optional) --}}
            <li><hr class="dropdown-divider my-2 mx-3" style="border-color: rgba(255,255,255,0.2);"></li>

            {{-- DATA MASTER (Dropdown Menu Baru) --}}
            <li class="menu-dropdown 
                {{ request()->is('she/master/pta*') || request()->is('she/master/kta*') || request()->is('she/master/pb*') ? 'open' : '' }}"
            >
                <a href="#" class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#submenuDataMaster" aria-expanded="false">
                    <i class="bi bi-database"></i> <span>Data Master</span>
                    <i class="bi bi-chevron-right dropdown-toggle-icon"></i>
                </a>
                
                <ul class="submenu collapse 
                    {{ request()->is('she/master/pta*') || request()->is('she/master/kta*') || request()->is('she/master/pb*') ? 'show' : '' }}" 
                    id="submenuDataMaster" 
                    data-bs-parent=".menu"
                >
                    {{-- Data Master - Perilaku Tidak Aman --}}
                    <li>
                        <a href="/she/master/pta"
                           class="{{ request()->is('she/master/pta*') ? 'active' : '' }}">
                            <i class="bi bi-dot"></i> <span>Hyari - PTA</span>
                        </a>
                    </li>
                    {{-- Data Master - Kondisi Tidak Aman --}}
                    <li>
                        <a href="/she/master/kta"
                           class="{{ request()->is('she/master/kta*') ? 'active' : '' }}">
                            <i class="bi bi-dot"></i> <span>Hyari - KTA</span>
                        </a>
                    </li>
                    {{-- Data Master - Potensi Bahaya --}}
                    <li>
                        <a href="/she/master/pb"
                           class="{{ request()->is('she/master/pb*') ? 'active' : '' }}">
                            <i class="bi bi-dot"></i> <span>Hyari - PB</span>
                        </a>
                    </li>
                </ul>
            </li>
